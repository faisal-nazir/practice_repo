	        ...
	        if (s2Row == 0 || s1Col == 0) {
	          ...
	          */
	          cache[s2Row][s1Col] = 0;
	        	...
	        	/* FNA: if you are confused about doing -1 then see DP table indices above
	        	 * because the table starts off with an empty string, the index of any character 
	        	 * in cache or DP table would be 1 + "character index in the string"  
	        	 * For example, the string "AGGTAB" would have the index 5 for the final 'B'
	        	 * where as table would index this as 6 i.e. 5+1
	        	 */
	          /*
